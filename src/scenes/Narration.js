export default class Narration extends Phaser.Scene {
  ...
  - Một bên cho rằng cơ thể con người chỉ là một vỏ bọc yếu ớt và họ cố gắng đưa trí tuệ và cảm xúc của con người vào những cỗ máy chiến đấu. Người cầm đầu tư tưởng là Javis rất đáng tiếc đã thất bại và có những hậu quả nghiêm trọng. Khắp các thành phố, các con đường ngập tràn hình bóng của những cỗ máy điên loạn. Những thứ khổng lồ, đáng sợ mang sức mạnh hủy diệt và sẵn sàng tiêu diệt nhân loại.
  ...
  Tuy nhiên, một thực tại đáng buồn hơn nữa, là do thời gian quá dài không phải sử dụng trí tuệ nên số lượng những cá nhân có bộ não ưu việt rất ít và không thể xây dựng những dự án lớn để cứu Trái Đất. Họ quyết định chế tạo cỗ máy thời gian quay trở về năm 2021 để tìm những nhân tài.
  ...
  create() {
    ...
    this.startNarration = this.add
      ...
      }, 0).setWordWrapWidth(950)
      .setFontSize(40)
    
      let skip = this.add
      .text(this.cameras.main.width / 2 + 400, this.cameras.main.height / 2 + 500, 'SKIP >>', {
